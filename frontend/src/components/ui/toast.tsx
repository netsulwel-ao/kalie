...
const toastVariants = {
  default: "glass-panel border border-white/10 text-white",
  destructive: "glass-panel border border-accent-sos/30 text-accent-sos",
  success: "glass-panel border border-accent-bisno/30 text-accent-bisno",
}
...
>(({ className, ...props }, ref) => (
  <ToastPrimitives.Action
    ref={ref}
    className={cn(
      "inline-flex h-8 shrink-0 items-center justify-center rounded-md border border-white/10 bg-transparent px-3 text-sm font-medium transition-colors hover:bg-white/10 focus:outline-none focus:ring-2 focus:ring-white/20 disabled:pointer-events-none disabled:opacity-50",
      className
    )}
    {...props}
  />
